  ...
  try {
    ...
    if (type === 'karigar' || type === 'all') {
      ...
      karigarData = {
        ...
        totalTransactionAmount: karigarTransactionSum._sum.amount || 0,
        monthlyTransactionCount,
        amountWeOwe: positiveTransactions._sum.amount || 0,
        amountOwedToUs: Math.abs(negativeTransactions._sum.amount || 0),
        topKarigars: topKarigarDetails,
        transactionChart: transactionsByDate,
      };
    }
    ...
    if (type === 'vyapari' || type === 'all') {
      ...
      vyapariData = {
        ...
        totalTransactionAmount: vyapariTransactionSum._sum.amount || 0,
        monthlyTransactionCount,
        amountWeOwe: positiveTransactions._sum.amount || 0,
        amountOwedToUs: Math.abs(negativeTransactions._sum.amount || 0),
